...
function Section2() {
  ...
  return (
    <div className="bg-transparent relative hero bg-gradient-to-r from-blue-500 to-green-500 mt-14">
      <section className="relative lg:min-h-[100px] pt-24 pb-10 sm:pt-32 sm:pb-16 lg:pb-24 ">
        <div className="px-4 mx-auto max-w-7xl sm:px-3 lg:px-2 relative z-20 mt-0 ">
          <div className="max-w-3xl mx-auto text-center ">
            {/* <h2 id="quote" data-aos="fade-up" data-aos-duration="3000" class="aos-init aos-animate">The LARGEST<br>
                            Tech &amp; Startup
                            <br>
                            show in Africa</h2> */}
            ...
            <h1
              ...
              className="text-2xl font-bold text-white sm:text-2xl lg:text-3xl"
            >
