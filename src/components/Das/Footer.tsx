  ...
  return (
    <section>
      <footer className="bg-white">
        <div className="container md:px-40 px-4 py-10 mx-auto">
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4">
            ...
            <div>
              ...
              <div className="flex flex-col items-start mt-5 space-y-2">
                <a
                  href="#"
                  className="text-black transition-colors duration-300  dark:hover:text-blue-400 hover:underline hover:text-blue-500"
                >
